<?php $__env->startSection('title'); ?>
    <?php echo e($node->name); ?>: Settings
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content-header'); ?>
    <h1><?php echo e($node->name); ?><small>Configure your node settings.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="<?php echo e(route('admin.nodes.view.settings', $node->id)); ?>">Settings</a></li>
...
<form action="<?php echo e(route('admin.nodes.view.settings', $node->id)); ?>" method="POST">
    <div class="row">
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <input type="text" autocomplete="off" name="name" class="form-control" value="<?php echo e(old('name', $node->name)); ?>" />
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <textarea name="description" id="description" rows="4" class="form-control"><?php echo e($node->description); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <select name="location_id" class="form-control">
                                <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($location->id); ?>" <?php echo e((((int) old('location_id', $node->location_id)) === $location->id) ? 'selected' : ''); ?>><?php echo e($location->long); ?> (<?php echo e($location->short); ?>)</option>
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <input type="radio" name="public" value="1" <?php echo e((old('public', $node->public)) ? 'checked' : ''); ?> id="public_1" checked> <label for="public_1" style="padding-left:5px;">Yes</label><br />
                            <input type="radio" name="public" value="0" <?php echo e((old('public', $node->public)) ? '' : 'checked'); ?> id="public_0"> <label for="public_0" style="padding-left:5px;">No</label>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <label for="fqdn" class="control-label">Fully Qualified Domain Name</label>
                        <div>
                            <input type="text" autocomplete="off" name="fqdn" class="form-control" value="<?php echo e(old('fqdn', $node->fqdn)); ?>" />
                        </div>
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <input type="text" autocomplete="off" name="deploy_fee" class="form-control" value="<?php echo e(old('deploy_fee', $node->deploy_fee)); ?>" />
                        </div>
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pSSLTrue" value="https" name="scheme" <?php echo e((old('scheme', $node->scheme) === 'https') ? 'checked' : ''); ?>>
                                <label for="pSSLTrue"> Use SSL Connection</label>
                            </div>
                            <div class="radio radio-danger radio-inline">
                                <input type="radio" id="pSSLFalse" value="http" name="scheme" <?php echo e((old('scheme', $node->scheme) !== 'https') ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pProxyFalse" value="0" name="behind_proxy" <?php echo e((old('behind_proxy', $node->behind_proxy) == false) ? 'checked' : ''); ?>>
                                <label for="pProxyFalse"> Not Behind Proxy </label>
                            </div>
                            <div class="radio radio-info radio-inline">
                                <input type="radio" id="pProxyTrue" value="1" name="behind_proxy" <?php echo e((old('behind_proxy', $node->behind_proxy) == true) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pMaintenanceFalse" value="0" name="maintenance_mode" <?php echo e((old('behind_proxy', $node->maintenance_mode) == false) ? 'checked' : ''); ?>>
                                <label for="pMaintenanceFalse"> Disabled</label>
                            </div>
                            <div class="radio radio-warning radio-inline">
                                <input type="radio" id="pMaintenanceTrue" value="1" name="maintenance_mode" <?php echo e((old('behind_proxy', $node->maintenance_mode) == true) ? 'checked' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="memory" class="form-control" data-multiplicator="true" value="<?php echo e(old('memory', $node->memory)); ?>"/>
                            ...
                            <div class="form-group col-xs-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="memory_overallocate" class="form-control" value="<?php echo e(old('memory_overallocate', $node->memory_overallocate)); ?>"/>
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="disk" class="form-control" data-multiplicator="true" value="<?php echo e(old('disk', $node->disk)); ?>"/>
                                    <span class="input-group-addon">MiB</span>
                                </div>
                            </div>
                            <div class="form-group col-xs-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="disk_overallocate" class="form-control" value="<?php echo e(old('disk_overallocate', $node->disk_overallocate)); ?>"/>
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        ...
                        <div class="input-group">
                            <input type="text" name="upload_size" class="form-control" value="<?php echo e(old('upload_size', $node->upload_size)); ?>"/>
                            <span class="input-group-addon">MiB</span>
                        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="text" name="daemonListen" class="form-control" value="<?php echo e(old('daemonListen', $node->daemonListen)); ?>"/>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="text" name="daemonSFTP" class="form-control" value="<?php echo e(old('daemonSFTP', $node->daemonSFTP)); ?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pDeployableTrue" value="1" name="deployable" <?php echo e((old('deployable', $node->deployable)) ? 'checked' : ''); ?>>
                                <label for="pDeployableTrue"> Allow</label>
                            </div>
                            <div class="radio radio-danger radio-inline">
                                <input type="radio" id="pDeployableFalse" value="0" name="deployable" <?php echo e((old('deployable', $node->deployable)) ? '' : 'checked'); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/jexactyl/resources/views/admin/nodes/view/settings.blade.php ENDPATH**/ ?>
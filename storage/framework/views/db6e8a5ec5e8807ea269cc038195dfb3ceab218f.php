                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="webhook" id="webhook" class="form-control" value="<?php echo e($webhook); ?>">
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <form id="massdenyform" action="<?php echo e(route('admin.jexactyl.approvals.all', 'deny')); ?>" method="POST">
                        <?php echo csrf_field(); ?>

                        <button id="denyAllBtn" class="btn btn-danger pull-right">Deny All</button>
                    </form>
                    <form id="massapproveform" action="<?php echo e(route('admin.jexactyl.approvals.all', 'approve')); ?>" method="POST">
                        <?php echo csrf_field(); ?>

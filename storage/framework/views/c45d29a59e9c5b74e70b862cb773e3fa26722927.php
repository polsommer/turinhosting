<?php $__env->startSection('title'); ?>
    <?php echo e($node->name); ?>: Allocations
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content-header'); ?>
    <h1><?php echo e($node->name); ?><small>Control allocations available for servers on this node.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="<?php echo e(route('admin.nodes.view.allocation', $node->id)); ?>">Allocation</a></li>
...
<div class="row">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive no-padding" style="overflow-x: visible">
                <table class="table table-hover" style="margin-bottom:0;">
                    ...
                    <?php $__currentLoopData = $node->allocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allocation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="middle min-size" data-identifier="type">
                                <?php if(is_null($allocation->server_id)): ?>
                            ...
                            <td class="col-sm-3 middle" data-identifier="ip"><?php echo e($allocation->ip); ?></td>
                            <td class="col-sm-3 middle">
                                <input class="form-control input-sm" type="text" value="<?php echo e($allocation->ip_alias); ?>" data-action="set-alias" data-id="<?php echo e($allocation->id); ?>" placeholder="none" />
                            </td>
                            <td class="col-sm-2 middle" data-identifier="port"><?php echo e($allocation->port); ?></td>
                            <td class="col-sm-3 middle">
                                <?php if(! is_null($allocation->server)): ?>
                                    <a href="<?php echo e(route('admin.servers.view', $allocation->server_id)); ?>"><?php echo e($allocation->server->name); ?></a>
                                <?php endif; ?>
                            </td>
                            <td class="col-sm-1 middle">
                                <?php if(is_null($allocation->server_id)): ?>
                                    <button data-action="deallocate" data-id="<?php echo e($allocation->id); ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></button>
                                <?php endif; ?>
                            </td>
                        </tr>
            ...
            <?php if($node->allocations->hasPages()): ?>
                <div class="box-footer text-center">
                    <?php echo e($node->allocations->render()); ?>
    ...
    <div class="col-sm-4">
        <form action="<?php echo e(route('admin.nodes.view.allocation', $node->id)); ?>" method="POST">
                        ...
                        <div>
                            <select class="form-control" name="allocation_ip" id="pAllocationIP" multiple>
                                <?php $__currentLoopData = $allocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allocation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($allocation->ip); ?>"><?php echo e($allocation->ip); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<div class="modal fade" id="allocationModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.nodes.view.allocation.removeBlock', $node->id)); ?>" method="POST">
...
<?php $__env->startSection('footer-scripts'); ?>
    ...
    $('button[data-action="deallocate"]').click(function (event) {
        ...
        swal({
            ...
            $.ajax({
                method: 'DELETE',
                url: '/admin/nodes/view/' + <?php echo e($node->id); ?> + '/allocation/remove/' + allocation,
    ...
    function sendAlias(element) {
        ...
        $.ajax({
            method: 'POST',
            url: '/admin/nodes/view/' + <?php echo e($node->id); ?> + '/allocation/alias',
            headers: { 'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
            data: {
                alias: element.val(),
    ...
    function deleteSelected() {
        ...
        if (selectedItems.length !== 0) {
            ...
            swal({
                ...
                $.ajax({
                    method: 'DELETE',
                    url: '/admin/nodes/view/' + <?php echo e($node->id); ?> + '/allocations',
                    headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')},
                    data: JSON.stringify({
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/jexactyl/resources/views/admin/nodes/view/allocation.blade.php ENDPATH**/ ?>
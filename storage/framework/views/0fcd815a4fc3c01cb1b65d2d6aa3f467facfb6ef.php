                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-<?php echo e($stats['disk']['css']); ?>">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                ...
                                <span class="info-box-number"><?php echo e($stats['disk']['value']); ?> / <?php echo e($stats['disk']['max']); ?> MiB</span>
                                <div class="progress">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-<?php echo e($stats['memory']['css']); ?>">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                ...
                                <span class="info-box-number"><?php echo e($stats['memory']['value']); ?> / <?php echo e($stats['memory']['max']); ?> MiB</span>
                                <div class="progress">

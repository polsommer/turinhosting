                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="checkbox checkbox-primary no-margin-bottom">
                                <input id="pStartOnCreation" name="start_on_completion" type="checkbox" <?php echo e(\Jexactyl\Helpers\Utilities::checked('start_on_completion', 1)); ?> />
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <div class="checkbox checkbox-primary no-margin-bottom">
                            <input type="checkbox" id="pOomDisabled" name="oom_disabled" value="0" <?php echo e(\Jexactyl\Helpers\Utilities::checked('oom_disabled', 0)); ?> />
        ...
        <div class="col-md-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <div class="checkbox checkbox-primary no-margin-bottom">
                            <input type="checkbox" id="pSkipScripting" name="skip_scripts" value="1" <?php echo e(\Jexactyl\Helpers\Utilities::checked('skip_scripts', 0)); ?> />

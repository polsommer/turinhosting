<?php echo $__env->make('partials/admin.jexactyl.nav', ['activeTab' => 'mail'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input required type="text" class="form-control" name="mail:mailers:smtp:host" value="<?php echo e(old('mail:mailers:smtp:host', config('mail.mailers.smtp.host'))); ?>" />
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <div>
                                        <input required type="number" class="form-control" name="mail:mailers:smtp:port" value="<?php echo e(old('mail:mailers:smtp:port', config('mail.mailers.smtp.port'))); ?>" />
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="mail:mailers:smtp:encryption" class="form-control">
                                            <option value="" <?php if($encryption === ''): ?> selected <?php endif; ?>>None</option>
                                            <option value="tls" <?php if($encryption === 'tls'): ?> selected <?php endif; ?>>Transport Layer Security (TLS)</option>
                                            <option value="ssl" <?php if($encryption === 'ssl'): ?> selected <?php endif; ?>>Secure Sockets Layer (SSL)</option>
                                        </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="mail:mailers:smtp:username" value="<?php echo e(old('mail:mailers:smtp:username', config('mail.mailers.smtp.username'))); ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input required type="email" class="form-control" name="mail:from:address" value="<?php echo e(old('mail:from:address', config('mail.from.address'))); ?>" />
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="mail:from:name" value="<?php echo e(old('mail:from:name', config('mail.from.name'))); ?>" />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/jexactyl/resources/views/admin/jexactyl/mail.blade.php ENDPATH**/ ?>
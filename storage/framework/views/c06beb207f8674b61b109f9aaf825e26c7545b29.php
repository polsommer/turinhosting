        ...
        <div class="col-xs-12">
            ...
            ">
                ...
                <div class="box-body">
                    ...
                    <?php else: ?>
                        Jexactyl is not up-to-date. <code><?php echo e(config('app.version')); ?> (current) -> <a href="https://github.com/jexactyl/jexactyl/releases/v<?php echo e($version->getPanel()); ?>" target="_blank"><?php echo e($version->getPanel()); ?></a> (latest)</code>
                    <?php endif; ?>
                </div>
            </div>
        </div>

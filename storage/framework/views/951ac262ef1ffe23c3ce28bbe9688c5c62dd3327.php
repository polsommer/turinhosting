    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="<?php echo e(route('admin.jexactyl.registration')); ?>" method="POST">
                <div class="box
                <?php if($enabled == 'true'): ?> box-success <?php else: ?> box-danger <?php endif; ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <select name="registration:verification" class="form-control">
                                        <option <?php if($verification == 'false'): ?> selected <?php endif; ?> value="false">Disabled</option>
                                        <option <?php if($verification == 'true'): ?> selected <?php endif; ?> value="true">Enabled</option>
                                    </select>
                ...
                <div class="box <?php if($discord_enabled == 'true'): ?> box-success <?php else: ?> box-danger <?php endif; ?>">
                    <div class="box-header with-border">

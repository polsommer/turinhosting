<?php echo $__env->make('partials/admin.jexactyl.nav', ['activeTab' => 'advanced'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->yieldContent('jexactyl::nav'); ?>
        <form action="<?php echo e(route('admin.jexactyl.advanced')); ?>" method="POST">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                                    ...
                                    <div>
                                        <div class="btn-group" data-toggle="buttons">
                                            ...
                                            <label class="btn btn-primary <?php if($level == 0): ?> active <?php endif; ?>">
                                                <input type="radio" name="jexactyl:auth:2fa_required" autocomplete="off" value="0" <?php if($level == 0): ?> checked <?php endif; ?>> Not Required
                                            </label>
                                            <label class="btn btn-primary <?php if($level == 1): ?> active <?php endif; ?>">
                                                <input type="radio" name="jexactyl:auth:2fa_required" autocomplete="off" value="1" <?php if($level == 1): ?> checked <?php endif; ?>> Admin Only
                                            </label>
                                            <label class="btn btn-primary <?php if($level == 2): ?> active <?php endif; ?>">
                                                <input type="radio" name="jexactyl:auth:2fa_required" autocomplete="off" value="2" <?php if($level == 2): ?> checked <?php endif; ?>> All Users
                                            </label>
                                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input type="number" required class="form-control" name="jexactyl:guzzle:connect_timeout" value="<?php echo e(old('jexactyl:guzzle:connect_timeout', config('jexactyl.guzzle.connect_timeout'))); ?>">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input type="number" required class="form-control" name="jexactyl:guzzle:timeout" value="<?php echo e(old('jexactyl:guzzle:timeout', config('jexactyl.guzzle.timeout'))); ?>">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <select class="form-control" name="jexactyl:client_features:allocations:enabled">
                                            ...
                                            <option value="true" <?php if(old('jexactyl:client_features:allocations:enabled', config('jexactyl.client_features.allocations.enabled'))): ?> selected <?php endif; ?>>Enabled</option>
                                        </select>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" name="jexactyl:client_features:allocations:range_start" value="<?php echo e(old('jexactyl:client_features:allocations:range_start', config('jexactyl.client_features.allocations.range_start'))); ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" name="jexactyl:client_features:allocations:range_end" value="<?php echo e(old('jexactyl:client_features:allocations:range_end', config('jexactyl.client_features.allocations.range_end'))); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/jexactyl/resources/views/admin/jexactyl/advanced.blade.php ENDPATH**/ ?>
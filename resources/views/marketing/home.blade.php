@extends('templates/marketing-wrapper')

@section('title', config('app.name', 'Everest') . ' | Hosting for your next project')
@section('description', 'Everest delivers secure, scalable infrastructure with predictable pricing so you can focus on building your next project.')
